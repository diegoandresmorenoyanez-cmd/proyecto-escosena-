...
## 🗄️ Modelo de Datos
El diagrama de entidad-relación y la estructura de las tablas se encuentran disponibles en la documentación.


## 🧱 Arquitectura
El detalle de la arquitectura del sistema y el flujo de datos está documentado en su respectiva sección.
